...
class Plane(object):
    ...
    def __eq__(self, plane):
        #if normal vector of plane is zero vector
...
x = Plane(normal_vector=Vector(['-0.412', '3.806', '0.728']), constant_term='-3.46')
y = Plane(normal_vector=Vector(['1.03', '-9.515', '-1.82']), constant_term='8.65')

print(x.is_parallel_to(y))